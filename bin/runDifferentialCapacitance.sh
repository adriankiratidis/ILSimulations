...
mv /home/adriank/postdoc/2018/branch/ILSimulations/run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/35.51-53.27_C4MIM_BF4--0.005-0-${surface_charge_density_left_wall}-hs1.0TESTINGDIFFERENTIALCAPACITANCE2/testing14-a2-electric_potential_and_charge.txt ~/postdoc/2018/branch/ILSimulations
