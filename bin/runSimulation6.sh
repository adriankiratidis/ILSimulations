...
chi_parameter=0.71
Epsilon_r=13.9
Epsilon_LJ_particle_particle=100.0 # ( = epsilon_LJ * k_{B})
...
bulk_density=0.044			# ( =n_{b} * [hs_diameter**3] )
...
number_of_separations=390  #The number of plate separations we'll calculate.
number_of_plate_separations_in_hs_diameter=30
...
write_dir="./run_results/compare_epsilonLJ/charge/${Epsilon_LJ_particle_particle}-${Epsilon_LJ_particle_wall}_${ionic_liquid_name}TESTING_OSCILLATION_COMPARE"
mkdir -p ${write_dir}
