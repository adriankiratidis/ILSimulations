...
epsilon_eighth_power_const=304.762
...
write_dir="./run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/${Epsilon_LJ_particle_particle}-${Epsilon_LJ_particle_wall}_${ionic_liquid_name}-${bulk_density}-${epsilon_eighth_power_const}-${surface_charge_density_left_wall}"
mkdir -p ${write_dir}
