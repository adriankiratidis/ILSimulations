...
data_1 = np.loadtxt("../testing-n_plus_separation" + str(separation) + ".00000charge20.txt")
data_2 = np.loadtxt("../testing-n_neutral_separation" + str(separation) + ".00000charge20.txt")
data_3 = np.loadtxt("../testing-n_minus_separation" + str(separation) + ".00000charge20.txt")
data_4 = np.loadtxt("../testing-n_sbar_separation" + str(separation) + ".00000charge20.txt")
data_5 = np.loadtxt("../testing-n_s_separation" + str(separation) + ".00000charge20.txt")
...
plt.plot(x_3+0.06,y_3,'rs',label=r'$n_{-}$')
plt.plot(x_4,y_4,'ch',label=r'$\bar{n}_{s}$')
plt.plot(x_5,y_5,'k^',label=r'${n}_{s}$')
