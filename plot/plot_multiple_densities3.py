...
data_1 = np.loadtxt("../run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/35.51-0_Hexamer_SingleSphere-0.005-0-"+r4r8+"-"+wall_charge+"-hs1.0CHARGE/testing-a2-n_plus_separation"+separation+"0000charge1.txt")
data_2 = np.loadtxt("../run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/35.51-0_Hexamer_SingleSphere-0.005-0-"+r4r8+"-"+wall_charge+"-hs1.0CHARGE/testing-a2-n_neutral_separation"+separation+"0000charge1.txt")
data_3 = np.loadtxt("../run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/35.51-0_Hexamer_SingleSphere-0.005-0-"+r4r8+"-"+wall_charge+"-hs1.0CHARGE/testing-a2-n_minus_separation"+separation+"0000charge1.txt")
...
data_1_end2 = np.loadtxt("../run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/35.51-0_Hexamer_SingleSphere-0.005-180-"+r4r8+"-"+wall_charge+"-hs1.0CHARGE/testing10-a2-n_plus_separation"+separation+"0000charge1.txt")
data_2_end2 = np.loadtxt("../run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/35.51-0_Hexamer_SingleSphere-0.005-180-"+r4r8+"-"+wall_charge+"-hs1.0CHARGE/testing10-a2-n_neutral_separation"+separation+"0000charge1.txt")
data_3_end2 = np.loadtxt("../run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/35.51-0_Hexamer_SingleSphere-0.005-180-"+r4r8+"-"+wall_charge+"-hs1.0CHARGE/testing10-a2-n_minus_separation"+separation+"0000charge1.txt")
...
y_1_end2 = data_1_end2[:,1]

x_2_end2 = data_2_end2[:,0]
y_2_end2 = data_2_end2[:,1]

x_3_end2 = data_3_end2[:,0]
y_3_end2 = data_3_end2[:,1]
...
plt.plot(x_1,y_1,'bx',label=r'$n_{+}$')
...
plt.plot(x_1_end2,y_1_end2,'y^',label=r'$n_{+}$ (C=180)')
plt.plot(x_2_end2,y_2_end2,'k*',label=r'$n_{0}$ (C=180)')
plt.plot(x_3_end2,y_3_end2,'m<',label=r'$n_{-}$ (C=180)')
...
#savefig("Densities-Hexamer_SingleSphere--density0.005-epsilon35.51-0-sep"+separation+"_"+r4r8+"-"+ wall_charge+".pdf", bbox_inches='tight')
