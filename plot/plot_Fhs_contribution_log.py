...
data_1 = np.loadtxt("../testing-log-iteration1.txt")
data_2 = np.loadtxt("../testing-log-iteration2.txt")
data_3 = np.loadtxt("../testing-log-iteration3.txt")
data_4 = np.loadtxt("../testing-log-iteration4.txt")
data_5 = np.loadtxt("../testing-log-iteration5.txt")
data_6 = np.loadtxt("../testing-log-iteration6.txt")
data_7 = np.loadtxt("../testing-log-iteration7.txt")
data_8 = np.loadtxt("../testing-log-iteration8.txt")
data_9 = np.loadtxt("../testing-log-iteration9.txt")
...
plt.ylabel("Log Term Value",labelpad=5)
...
savefig("Fhs_contribution_log.pdf",bbox_inches='tight')
