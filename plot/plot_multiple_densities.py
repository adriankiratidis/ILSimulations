...
data_1 = np.loadtxt("../run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/35.51-88.78_C4MIM_BF4--0.005-9.5238--0.003125/testing7-a2-n_plus_separation3.50000charge1.txt")
data_2 = np.loadtxt("../run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/35.51-88.78_C4MIM_BF4--0.005-9.5238--0.003125/testing7-a2-n_neutral_separation3.50000charge1.txt")
data_3 = np.loadtxt("../run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/35.51-88.78_C4MIM_BF4--0.005-9.5238--0.003125/testing7-a2-n_minus_separation3.50000charge1.txt")
data_4 = np.loadtxt("../run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/35.51-88.78_C4MIM_BF4--0.005-9.5238--0.003125/testing7-a2-n_cation_centre3.50000charge1.txt")
data_5 = np.loadtxt("../run_results/compare_epsilonLJ/CentreCentrePotential/minuswalls/35.51-88.78_C4MIM_BF4--0.005-9.5238--0.003125/testing7-a2-n_anion_centre3.50000charge1.txt")
...
plt.plot(x_4,y_4,'y^',label=r'$5n_{+}^{C}$')
plt.plot(x_5,y_5,'k>',label=r'$5n_{-}^{C}$')
...
savefig("testing.pdf", bbox_inches='tight')
#savefig("Densities_C4MIM_BF4_Negative_Wall_Charge-C20-sep3.5-pw88.78.pdf", bbox_inches='tight')
