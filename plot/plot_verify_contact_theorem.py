...
for j in range(len(charges)):
   for i in range(len(ELJ_wall)):
      data_contactthm2 = np.loadtxt("../run_results/compare_epsilonLJ/"+charges[j]+"/35.51-53.27_C4MIM_BF4--0.005-10-0.00-LongTEST2/testing"+ELJ_wall_index[i]+"-a2-normal-pressure-left-wall.txt")
      data_negativederiv2 = np.loadtxt("../run_results/compare_epsilonLJ/"+charges[j]+"/35.51-53.27_C4MIM_BF4--0.005-10-0.00-LongTEST2/testing"+ELJ_wall_index[i]+"-a2-negative_deriv_of_potential.txt")

      #data_contactthm2_zero = np.loadtxt("../run_results/compare_epsilonLJ/"+charges[j]+"/35.51-53.27_C4MIM_BF4--0.005-0-0.00-LongTEST/testing"+ELJ_wall_index[i]+"-a2-normal-pressure-left-wall.txt")
      #data_negativederiv2_zero = np.loadtxt("../run_results/compare_epsilonLJ/"+charges[j]+"/35.51-53.27_C4MIM_BF4--0.005-0-0.00-LongTEST/testing"+ELJ_wall_index[i]+"-a2-negative_deriv_of_potential.txt")
      ...
      # x_contactthm_zero = data_contactthm2_zero[:,0]
      # y_contactthm_zero = data_contactthm2_zero[:,1]*(10**30)
      # y_contactthm_zero = y_contactthm_zero - y_contactthm_zero[-1]
      # x_negativederiv_zero = data_negativederiv2_zero[:,0]
      # y_negativederiv_zero = data_negativederiv2_zero[:,1]*(10**30)
