...
data_1 = np.loadtxt("../testing-extra_integral_contribution-iteration1.txt")
data_2 = np.loadtxt("../testing-extra_integral_contribution-iteration2.txt")
data_3 = np.loadtxt("../testing-extra_integral_contribution-iteration3.txt")
data_4 = np.loadtxt("../testing-extra_integral_contribution-iteration4.txt")
data_5 = np.loadtxt("../testing-extra_integral_contribution-iteration5.txt")
data_6 = np.loadtxt("../testing-extra_integral_contribution-iteration6.txt")
data_7 = np.loadtxt("../testing-extra_integral_contribution-iteration7.txt")
data_8 = np.loadtxt("../testing-extra_integral_contribution-iteration8.txt")
data_9 = np.loadtxt("../testing-extra_integral_contribution-iteration9.txt")
...
plt.ylabel("Integral Term Value",labelpad=5)
...
savefig("Fhs_extra_integral_contribution.pdf",bbox_inches='tight')
