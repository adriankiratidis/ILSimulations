...
contacttheorem.o: kinds.o helpers.o parameters.o discretederivatives.o
discretederivatives.o: kinds.o parameters.o
ILsimulationssrclib.o: kinds.o universalconstants.o parameters.o integratephispherical.o integratezcylindrical.o iteration.o lambdas.o helpers.o io.o normalisation.o surfaceforces.o functionalderivatives.o constructoligomers.o contacttheorem.o discretederivatives.o
